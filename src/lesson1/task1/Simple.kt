...
{
    val year1: Double = initial * (percent / 100.0)
    val year2 = (initial + year1) * (percent / 100.0)
    val year3 = (initial + year1 + year2) * (percent / 100.0)
    return initial + year1 + year2 + year3
}
/**
 * Простая
 *
...
{
    val a1:Int = number / 100
    val a2:Int = (number - a1 * 100) / 10
    val a3:Int = (number - a1 * 100 - a2 * 10)
